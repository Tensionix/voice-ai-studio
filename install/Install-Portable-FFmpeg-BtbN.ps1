<#
.SYNOPSIS
  Audion Voice AI Studio - install portable BtbN FFmpeg into Tools\ffmpeg.
...
$Headers = @{ 'User-Agent' = 'Audion-Voice-AI-Studio' }
...
Write-Host "======================================================================"
Write-Host "  AUDION VOICE AI STUDIO - INSTALL PORTABLE FFMPEG BTBN"
Write-Host "======================================================================"
