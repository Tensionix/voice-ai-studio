...
- Run: `20260901T044103Z_audion-voice-ai-studio_7257c1df`
- Project root: `S:\Release\Audion Voice AI Studio`
- Scan root: `S:\Release\Audion Voice AI Studio`
- Output: `S:\Release\Audion Voice AI Studio\licenses`
- Status: **PASS**
- Components: 63
- Bundled: 63
- Optional runtime: 0
...
| filelock | `VERSION_OR_ARTIFACT_CHANGED_LICENSE_SAME` | 3.32.5 | 3.32.5 |
| flatbuffers | `VERSION_OR_ARTIFACT_CHANGED_LICENSE_SAME` | 25.12.19 | 25.12.19 |
| fsspec | `VERSION_OR_ARTIFACT_CHANGED_LICENSE_SAME` | 2026.7.0 | 2026.7.0 |
| fzf | `UNCHANGED` | bundled | bundled |
| h11 | `VERSION_OR_ARTIFACT_CHANGED_LICENSE_SAME` | 0.16.0 | 0.16.0 |
| hf-xet | `VERSION_OR_ARTIFACT_CHANGED_LICENSE_SAME` | 1.6.0 | 1.6.0 |
...
| huggingface_hub | `VERSION_OR_ARTIFACT_CHANGED_LICENSE_SAME` | 1.29.0 | 1.29.0 |
...
| numpy | `VERSION_OR_ARTIFACT_CHANGED_LICENSE_SAME` | 2.3.5 | 2.3.5 |
| nvidia-cublas-cu12 | `VERSION_OR_ARTIFACT_CHANGED_LICENSE_SAME` | 12.9.2.10 | 12.9.2.10 |
| nvidia-cuda-nvrtc-cu12 | `VERSION_OR_ARTIFACT_CHANGED_LICENSE_SAME` | 12.9.86 | 12.9.86 |
| nvidia-cuda-runtime-cu12 | `VERSION_OR_ARTIFACT_CHANGED_LICENSE_SAME` | 12.9.79 | 12.9.79 |
| nvidia-cudnn-cu12 | `VERSION_OR_ARTIFACT_CHANGED_LICENSE_SAME` | 9.24.0.43 | 9.24.0.43 |
| nvidia-cufft-cu12 | `VERSION_OR_ARTIFACT_CHANGED_LICENSE_SAME` | 11.4.1.4 | 11.4.1.4 |
| nvidia-curand-cu12 | `VERSION_OR_ARTIFACT_CHANGED_LICENSE_SAME` | 10.3.10.19 | 10.3.10.19 |
| nvidia-nvjitlink-cu12 | `VERSION_OR_ARTIFACT_CHANGED_LICENSE_SAME` | 12.9.86 | 12.9.86 |
| onnx-asr | `VERSION_OR_ARTIFACT_CHANGED_LICENSE_SAME` | 0.12.0 | 0.12.0 |
| onnxruntime | `VERSION_OR_ARTIFACT_CHANGED_LICENSE_SAME` | 1.29.0 | 1.29.0 |
| onnxruntime-directml | `VERSION_OR_ARTIFACT_CHANGED_LICENSE_SAME` | 1.24.4 | 1.24.4 |
| onnxruntime-gpu | `VERSION_OR_ARTIFACT_CHANGED_LICENSE_SAME` | 1.22.0 | 1.22.0 |
